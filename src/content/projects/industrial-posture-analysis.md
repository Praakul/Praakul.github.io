...
- ST-GCN
- FastAPI
description: Manual material handling is still one of the biggest causes of musculoskeletal
  injuries in factories, and traditional safety protocols just don't g...
