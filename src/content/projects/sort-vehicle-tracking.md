...
- Docker
- YOLOv8
description: I built a completely from-scratch implementation of the **SORT (Simple
  Online and Realtime Tracking)** algorithm to track multiple vehicles in traf...
